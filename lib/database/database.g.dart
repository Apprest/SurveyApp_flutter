...
class _$ReviewDAO extends ReviewDAO {
  ...
  @override
  Future<List<Review>> selectReviewsByMealName(String mealName) async {
    return _queryAdapter.queryList('SELECT * FROM reviews WHERE mealName = ?1',
  ...
  Future<List<Review>> getAllReviews() async {
    return _queryAdapter.queryList('SELECT * FROM reviews',
        mapper: (Map<String, Object?> row) => Review(
            reviewID: row['reviewID'] as int?,
            customerName: row['customerName'] as String?,
            customerPhone: row['customerPhone'] as String?,
